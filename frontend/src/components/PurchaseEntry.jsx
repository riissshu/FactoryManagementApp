...
export default function PurchaseEntry({ stockItems, entry, onSave, onClose }) {
        ...
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title fw-bold">
              {entry ? "Edit Purchase" : "Add Purchase"}
            </h5>
          ...
          <div className="modal-body">
            ...
            <div className="mb-4 col-auto">
              <label className="form-label fw-semibold">Purchase No.</label>
          ...
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                {compatibleClipboardItems.length > 0 && (
                  <>
                    <div className="fw-semibold mb-2">Purchase Entries</div>
                    ...
                    {compatibleClipboardItems.map((item) => (
                      ...
                      >
                        <div>
                          ...
                          <small className="text-muted">Purchase</small>
                        </div>

                        <button
                          type="button"
                          className="btn btn-sm btn-primary"
                          onClick={() => pastePurchaseFromClipboard(item)}
                        >
                          Paste
                        </button>
                      </div>
