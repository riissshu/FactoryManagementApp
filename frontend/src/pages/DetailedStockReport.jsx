...
//       reference_no: null,
//       inward_qty: Number(item.opening_qty) || 0,
//       outward_qty: 0,
//       unit: item.unit,
//       reason: null,
//       remarks: null,
//       balance_qty: Number(item.opening_qty) || 0,
//     };
...
//     filename: `${item?.item_name || "stock-item"}-detailed-stock-report.pdf`,
//     headers: [
//       "Date",
//       "Particulars",
//       "Reference",
...
// const exportExcel = () => {
//   exportTableExcel({
//     filename: `${item?.item_name || "stock-item"}-detailed-stock-report.xlsx`,
...
//         <div>
//           <h2 className="mb-1">Detailed Stock Report</h2>

//           {item && (
//             <div className="text-muted">
//               Stock Item: <strong>{item.item_name}</strong>
//             </div>
//           )}
//         </div>
...
//           <strong>Stock Movement - Entry Wise</strong>
//         </div>
...
//                         ? formatQty(row.inward_qty)
//                         : "-"}
//                     </td>

//                     <td className="text-end">
//                       {Number(row.outward_qty) > 0
//                         ? formatQty(row.outward_qty)
//                         : "-"}
//                     </td>
