...
const stockItems = [
  ...
  { id: 2, name: "Sand", unit: "Ton" },
  { id: 3, name: "Plastic Bag", unit: "Nos" },
  { id: 4, name: "Plastic Roll", unit: "Roll" },
  { id: 5, name: "Concrete Block", unit: "Nos" },
];
...
const [manufactured, setManufactured] = useState([
  ...
  const handleRowChange = (rows, setRows, index, field, value) => {
    ...
    if (field === "item") {
      const selected = stockItems.find((i) => i.name === value);
                  ...
                  <tr key={rowIndex}>
                    ...
                    <td>
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          temp[docIndex].items[rowIndex].unit =
                    ...
                    <td>
                      <input
                        ...
                        onChange={(e) => {
                          const temp = [...documents];
                          temp[docIndex].items[rowIndex].qty =
                            e.target.value;
                          setDocuments(temp);
                        }}
                      />
...
const renderManufacturingTable = (documents, setDocuments) => {
  const updateRow = (docIndex, rowIndex, table, field, value) => {
    ...
    if (field === "item") {
      ...
      temp[docIndex][table][rowIndex].unit = selected
        ? selected.unit
        : "";
    } else {
