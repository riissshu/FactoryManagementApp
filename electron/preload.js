...
contextBridge.exposeInMainWorld("api", {
  ...
  saveSettings: (factoryName, factoryLogo, masterPassword) =>
    ipcRenderer.invoke("settings:save", { factoryName, factoryLogo, masterPassword }),

  updateFactoryProfile: (data) => ipcRenderer.invoke("settings:updateProfile", data),
  ...
  renameStockGroup: (id, name) => ipcRenderer.invoke("stockGroups:rename", id, name),
  deactivateStockGroup: (id) => ipcRenderer.invoke("stockGroups:deactivate", id),

  getStockUnits: () => ipcRenderer.invoke("stockUnits:get"),
  addStockUnit: (name) => ipcRenderer.invoke("stockUnits:add", name),
  renameStockUnit: (id, name) => ipcRenderer.invoke("stockUnits:rename", id, name),
  ...
  updateLowQtyAlert: (id, value) => ipcRenderer.invoke("stock:updateLowQtyAlert", id, value),
  ...
  bulkCreateStockItems: (items) => ipcRenderer.invoke("stock:bulkCreate", items),
  ...
  updateDailyReport: (id, report) => ipcRenderer.invoke("dailyReport:update", id, report),
  deleteDailyReport: (id) => ipcRenderer.invoke("dailyReport:delete", id),

  // Backup / Restore
  createBackup: () => ipcRenderer.invoke("backup:create"),
  restoreBackup: () => ipcRenderer.invoke("backup:restore"),
  restoreFirstInstallBackup: () => ipcRenderer.invoke("backup:firstInstallRestore"),
  ...
  createNewDatabase: (options) => ipcRenderer.invoke("dbLocation:createNew", options),
  selectExistingDatabase: () => ipcRenderer.invoke("dbLocation:selectExisting"),
  moveDatabase: () => ipcRenderer.invoke("dbLocation:move"),
  setDefaultBackupDir: () => ipcRenderer.invoke("dbLocation:setDefaultBackupDir"),
  setDefaultRestoreDir: () => ipcRenderer.invoke("dbLocation:setDefaultRestoreDir"),
});